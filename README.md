Proyek ini merupakan aplikasi web e-commerce sederhana bernama Mr. Horas Bakery yang dikembangkan menggunakan Laravel sebagai bagian dari tugas kelompok pada mata kuliah Pengembangan Aplikasi Berbasis Internet. Aplikasi ini dirancang untuk mensimulasikan alur lengkap sebuah toko roti online, mulai dari penampilan katalog produk, detail setiap item, hingga proses penambahan ke keranjang dan transaksi checkout yang memuat informasi billing serta ringkasan pesanan. Sistem ini juga menyediakan panel dashboard khusus administrator yang memungkinkan pengelolaan data secara menyeluruh, seperti manajemen pengguna, kategori, produk, dan daftar pesanan, serta mendukung fungsi CRUD lengkap untuk produk. Selain itu, proyek ini memanfaatkan autentikasi bawaan Laravel untuk proses register, login, verifikasi email, hingga reset password, sekaligus mengintegrasikan komponen Livewire untuk menghadirkan antarmuka dinamis seperti cart, checkout, dan tampilan dashboard tanpa harus melakukan refresh halaman. Dengan memanfaatkan struktur MVC Laravel, routing yang sistematis, penyimpanan data berbasis MySQL, serta Blade Template untuk tampilan, proyek ini menjadi sarana pembelajaran yang komprehensif bagi tim beranggotakan lima orang dalam memahami proses pengembangan aplikasi web modern yang terstruktur, interaktif, dan fungsional.
Demo:
